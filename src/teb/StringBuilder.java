...
public class StringBuilder extends Bench {
	/*
	    @Override
	...
	*/
	@Override
	public String renderToString(final List<Stock> items) {
		java.lang.StringBuilder sb = new java.lang.StringBuilder(1024); // or
																		// new
																		// StringBuilder(8000)
		sb.append(""
